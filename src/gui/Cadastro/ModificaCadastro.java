 ...
 * @author BARRETO
 */
public class ModificaCadastro extends JFrame{
    ...
    public ModificaCadastro() throws ParseException{
        ...
        btnModificar.setBounds(220, 250, 100, 40);
       ...
       btnModificar.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                Logger.getLogger(ModificaCadastro.class.getName()).log(Level.SEVERE, null, ex);
            }
         });
    ...
    private void modificar(){
        ...
        try {
             ...
             opcoesCliente.modificar();
        } catch (Exception e) {
            System.out.println("Ocorreu um erro ao executar o evento :" + e);
        }
        new OpcoesCliente(cpf, nome, salario, endereco, data).modificar();
    }
